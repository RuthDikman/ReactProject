import "./cssLists/ListOfOrders.css";
...
const ListOfOrders = observer(() => {
  ...
  const getRowColor = (date) => {
    ...
    switch (true) {
      case rowDate.getDate() === currentDate.getDate() &&
        rowDate.getMonth() === currentDate.getMonth() &&
        rowDate.getFullYear() === currentDate.getFullYear():
        return "red";
      case isInComingWeek(rowDate) === isInComingWeek(currentDate):
        return "orange";
